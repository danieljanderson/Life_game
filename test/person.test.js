...
describe('testing person.js class', () => {
  ...
  it('will retrieve the charisma', () => {
    let daniel = new Person();
    daniel.charisma = 50
    expect(daniel.charisma).toBe(50);
  });
  // feeling property
  it('will retrieve the feelings', () => {
    let daniel = new Person()
    daniel.feeling=45;
    expect(daniel.feeling).toBe(45);
  });
  // intelligence property
  it('will retrieve the intelligence', () => {
    let daniel = new Person();
  ...
  //hobbies property
  it('will retrieve the hobbies array', () => {
    let daniel = new Person();
  ...
  // has car
  it('will retrieve the value if he has a car or not', () => {
    let daniel = new Person();
    daniel.numberCar =1
    expect(daniel.numberCar).toBe(1);
  });
  //number of apps
  it('will retrieve the number of times someone applied for a job', () => {
    let daniel = new Person();
  ...
  // job related methods
  it('will add a app to the number of apps', () => {
    let daniel = new Person();
    daniel.applyForJob();
    daniel.applyForJob();
